...
template <> constexpr inline auto KeyBoard::qt_create_metaobjectdata<qt_meta_tag_ZN8KeyBoardE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "KeyBoard",
        "slotKeyBoardMinimizeBtnClicked",
        "",
        "slotKeyBoardMaximizeBtnClicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'slotKeyBoardMinimizeBtnClicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'slotKeyBoardMaximizeBtnClicked'
...
void KeyBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->slotKeyBoardMinimizeBtnClicked(); break;
        case 1: _t->slotKeyBoardMaximizeBtnClicked(); break;
        default: ;
        }
    }
    (void)_a;
